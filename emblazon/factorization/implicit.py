...
from emblazon.factorization._components import _predict_process_ids
from emblazon.losses import (adaptive_hinge_loss,
                              bpr_loss,
                              hinge_loss,
                              pointwise_loss)
from emblazon.factorization.representations import BilinearNet
...
class ImplicitFactorizationModel(object):
    ...
    :class:`emblazon.factorization.representations.BilinearNet`.
    ...
    loss: string, optional
        ...
        corresponding to losses from :class:`emblazon.losses`.
    ...
    def fit(self, interactions, verbose=False):
        ...
        interactions: :class:`emblazon.interactions.Interactions`
            The input dataset.
