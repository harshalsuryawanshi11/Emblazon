...
from emblazon.helpers import _repr_model
from emblazon.losses import (adaptive_hinge_loss,
                              bpr_loss,
                              hinge_loss,
                              pointwise_loss)
from emblazon.sequence.representations import (PADDING_IDX, CNNNet,
                                                LSTMNet,
                                                MixtureLSTMNet,
                                                PoolNet)
from emblazon.sampling import sample_items
from emblazon.torch_utils import cpu, gpu, minibatch, set_seed, shuffle
...
class ImplicitSequenceModel(object):
    ...
    loss: string, optional
        ...
        to losses from :class:`emblazon.losses`.
    representation: string or instance of :class:`emblazon.sequence.representations`, optional
        Sequence representation to use. If string, it must be one
        of 'pooling', 'cnn', 'lstm', 'mixture'; otherwise must be one of the
        representations from :class:`emblazon.sequence.representations`
    ...
    :func:`emblazon.interactions.Interactions.to_sequence`.
    """
    ...
    def fit(self, interactions, verbose=False):
        ...
        interactions: :class:`emblazon.interactions.SequenceInteractions`
