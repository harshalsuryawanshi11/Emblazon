...
def mrr_score(model, test, train=None):
    ...
    test: :class:`emblazon.interactions.Interactions`
        Test interactions.
    train: :class:`emblazon.interactions.Interactions`, optional
...
def sequence_mrr_score(model, test, exclude_preceding=False):
    ...
    model: fitted instance of a recommender model
        The model to evaluate.
    test: :class:`emblazon.interactions.SequenceInteractions`
        Test interactions.
